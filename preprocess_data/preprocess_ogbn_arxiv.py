...
if __name__ == "__main__":
    # process ogbn-arxiv dataset and use metapath2vec model to generate features for other types of nodes
    args = {
        'cuda': 1,
        'embedding_dim': 128,
        'walk_length': 64,
    ...
    os.makedirs('../dataset/OGB_ARXIV', exist_ok=True)

    nodes_embedding_path = '../dataset/OGB_ARXIV/nodes_embedding.pkl'
    if os.path.exists(nodes_embedding_path):
        ...
        pyg_dataset = PygNodePropPredDataset(name='ogbn-arxiv', root='../dataset')
    ...
    graph_output_path = '../dataset/OGB_ARXIV/OGB_ARXIV.pkl'
    ...
    split_idx_output_path = '../dataset/OGB_ARXIV/OGB_ARXIV_split_idx.pkl'
