...
args = {
    'dataset': 'patent',
    'model_name': 'RGCN_lr0.001_dropout0.3_seed_0_link_prediction_mean',
    ...
    'norm': True,
    'use_self_loop': True,
    'batch_size': 2560,  # the number of edges to train in each batch
    'node_neighbors_min_num': 10,  # number of sampled edges for each type for each GNN layer
    'negative_sample_edge_num': 5,
    'sample_edge_rate': 0.2,  # train: validate: test = 3 : 1 : 1
    'sampled_edge_type': 'patent_company',  # writes or affiliated_with, two kinds of predicted relations
    'optimizer': 'adam',
    'weight_decay': 0.0,
    'epochs': 500,
    'patience': 50,
    'add_patent_neighbor': False
}
root = '/home/huangyf/PreData/Dataset/Goodread_output/'
args['data_path'] = "/home/huangyf/PreData/R-HGNN-master-2/dataset/goodread_mlp_mlm2/2.pkl"
#args['data_path'] = "/home/huangyf/PreData/Dataset/Goodread_output/bert_raw.pkl"
...
def evaluate(model: nn.Module, loader: dgl.dataloading.NodeDataLoader, loss_func: nn.Module,
    ...
    with torch.no_grad():
        ...
        for batch, (input_nodes, positive_graph, negative_graph, blocks) in enumerate(loader_tqdm):
            ...
            filter_representation = {"patent": nodes_representation["patent"],
...
if __name__ == '__main__':
    ...
    for epoch in range(args['epochs']):
        ...
        for batch, (input_nodes, positive_graph, negative_graph, blocks) in enumerate(train_loader_tqdm):
            ...
            filter_representation = {"patent": nodes_representation["patent"], "company": nodes_representation["company"]}
