...
from HetSANN.HetSANN import HetSANN
"""
...
args = {
    'dataset': 'patent',
    'model_name': 'HetSANN_lr0.001_dropout0.3_seed_0_link_prediction_mean',
    'predict_category': 'patent',
    'seed': 0,
    'cuda': 2,
    'learning_rate': 0.001,
    'num_heads': 8,
    'hidden_units': 8, # todo 32
    'dropout': 0.1,
    'n_layers': 2,
    'residual': True,
    'use_self_loop': True,
    ...
    'epochs': 500,
    'patience': 50,
    'add_patent_neighbor': False     # 是否预测二阶邻居，即专利，若为true则在原图上加入专利-专利的边
}
