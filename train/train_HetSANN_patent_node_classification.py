...
args['data_path'] = "/home/huangyf/PreData/R-HGNN-master-2/dataset/goodread/giant_raw.pkl"
...
if __name__ == '__main__':
    ...
    hetSANN = HetSANN(graph=graph, input_dim_dict={ntype: graph.nodes[ntype].data['feat'].shape[1] for ntype in graph.ntypes},
