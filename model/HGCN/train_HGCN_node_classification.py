...
args = {
    'dataset': 'OGB_MAG',  # 'dataset': "US", # OGB_MAG, OAG_CS_Field_F1, OAG_CS_Field_F2, OAG_CS_Venue, Amazon
    'model_name': 'HGCN_node_classification_lr0.001_dropout0.1',
    'seed': 0,
    'cuda': 1,
    'learning_rate': 0.001,
    'num_heads': 8,
...
if __name__ == '__main__':
    ...
    print(f'the size of HGCN parameters is {count_parameters_in_KB(model[0])} KB.')
