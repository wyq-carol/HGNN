...
def count_parameters_in_KB(model: nn.Module):
    """
...
# def add_neighbor(graph, add_edge_type):
#     '''
#     为原始图加入额外的边，例如在专利异质图中加入专利-专利边，以便后续预测
#     Args:
#         graph: 原始图
#         add_edge_type: 加入边的种类
#
#     Returns:
#         返回加入边后的图
#     '''
...
#         {
#             'applicant_company': [('applicant', 'applicant_patent', 'patent'), ('patent', 'patent_company', 'company')],
#             'company_applicant': [('company', 'company_patent', 'patent'), ('patent', 'patent_applicant', 'applicant')]
#         }
#     )
